...
export type QuestionsByDifficulty = {
  hard: Question[];
...
const QuizHtml = () => {
  ...
  useEffect(() => {
    const categoryId = "63f824bf313a5b593a06f030";
    ...
    return (
      <main className="app">
        <div className="juego-terminado">
          ...
          {puntuación === 20 && (
            <button onClick={() => navigate("/hard-quiz")}>Bonus Button</button>
          )}
    ...
    <main className="app">
      ...
      {questions.length > 0 && (
        <div className="lado-derecho">
          {questions.length > 0 &&
            questions[preguntaActual] &&
            questions[preguntaActual].answers &&
